...
const BugBountyProgramme = () => {
  const jsonLd = {
    ...
    "description": "Guide complet pour créer un programme bug bounty : définir la portée, fixer les récompenses, choisir une plateforme (HackerOne, YesWeHack, Intigriti) et gérer les rapports de vulnérabilités."
  };
