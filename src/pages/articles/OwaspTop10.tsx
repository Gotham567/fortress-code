...
const OwaspTop10 = () => {
  const jsonLd = {
    ...
    "description": "Comprendre et corriger les 10 vulnérabilités web les plus critiques selon l'OWASP : injections, broken auth, SSRF, IDOR, XSS et stratégies de correction pour sécuriser vos applications."
  };
