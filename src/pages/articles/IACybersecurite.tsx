...
const IACybersecurite = () => {
  const jsonLd = {
    ...
    "description": "Guide complet sur l'IA en cybersécurité : usages défensifs, nouvelles menaces (deepfake, prompt injection, shadow AI), gouvernance, ISO 42001 et plan d'action pour les PME et ETI."
  };
