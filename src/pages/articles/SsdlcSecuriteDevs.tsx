  ...
  const jsonLd = [
    {
      ...
      "url": "https://securecyber.fr/actualites/ssdlc-securite-cycle-developpement",
      "mainEntityOfPage": { "@type": "WebPage", "@id": "https://securecyber.fr/actualites/ssdlc-securite-cycle-developpement" },
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "SSDLC : intégrer la sécurité dans le cycle de développement logiciel", "item": "https://securecyber.fr/actualites/ssdlc-securite-cycle-developpement" }
      ]
    }
  ];
