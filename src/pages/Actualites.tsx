...
const blogArticles = [
  { tag: "Article", title: "Threat Hunting proactif : détecter les APT avant qu'ils ne frappent", desc: "Méthode de threat hunting proactif : hypothèses de chasse, MITRE ATT&CK comme référentiel, outils (Velociraptor, SIEM, EDR), analyse des IOC/TTP et Pyramid of Pain pour les équipes SOC.", date: "29 Juin 2026", slug: "/actualites/threat-hunting-apt-detection-proactive", img: imgSOC },
  { tag: "Article", title: "Sécurité OT/ICS industrielle : NIS2 et systèmes de contrôle industriels", desc: "Protection des systèmes industriels OT/ICS : modèle Purdue, norme IEC 62443, segmentation IT/OT, incidents Stuxnet/Triton/Colonial Pipeline, scan passif Claroty/Dragos et conformité NIS2.", date: "29 Juin 2026", slug: "/actualites/securite-ot-ics-systemes-industriels-nis2", img: imgOT },
  { tag: "Article", title: "Pentest d'API REST : méthode OWASP API Top 10 et rapport", desc: "Méthodologie complète pour le pentest d'API REST : OWASP API Security Top 10 2023, outils (Burp Suite, Postman, FFUF, Nuclei), phases et structure du rapport de pentest API.", date: "29 Juin 2026", slug: "/actualites/pentest-api-rest-owasp-methode", img: imgPentest },
  { tag: "Article", title: "Sécuriser Microsoft Entra ID : audit et bonnes pratiques 2026", desc: "Audit Microsoft Entra ID (Azure AD) : MFA obligatoire, Conditional Access, Privileged Identity Management (PIM), détection compromissions, BloodHound et Purple Knight.", date: "29 Juin 2026", slug: "/actualites/securite-microsoft-entra-id-audit", img: imgAD },
  { tag: "Article", title: "Forensique après cyberattaque : collecte de preuves et chaîne de custody", desc: "Forensique numérique après cyberattaque : ordre de volatilité RFC 3227, collecte RAM et disques, chaîne de custody, outils (Volatility, Autopsy, DFIR-ORC) et coordination ANSSI/BEFTI.", date: "29 Juin 2026", slug: "/actualites/forensique-numerique-apres-cyberattaque-preuves", img: imgApres },
  { tag: "Article", title: "SSDLC : intégrer la sécurité dans le cycle de développement logiciel", desc: "Secure SDLC complet : threat modeling STRIDE/PASTA, SAST (Semgrep, SonarQube), DAST (OWASP ZAP), SCA (Snyk, OWASP Dependency-Check), secret scanning et DevSecOps.", date: "29 Juin 2026", slug: "/actualites/ssdlc-securite-cycle-developpement", img: imgVs },
  { tag: "Article", title: "Gestion des vulnérabilités et patch management en entreprise", desc: "Gestion des vulnérabilités : CVSS, EPSS, CISA KEV, scanners Nessus/Qualys/OpenVAS, SLA de patching, patch management Windows (WSUS/Intune) et Linux, et métriques MTTR.", date: "29 Juin 2026", slug: "/actualites/gestion-vulnerabilites-patch-management-entreprise", img: imgAudit },
  { tag: "Article", title: "Test d'intrusion physique et social engineering : méthode et portée", desc: "Pentest physique en entreprise : tailgating, badge cloning, pretexting, vishing, USB drop — comment évaluer la sécurité physique et humaine et durcir les contrôles d'accès.", date: "28 Juin 2026", slug: "/actualites/test-intrusion-physique-social-engineering", img: imgPentest },
  { tag: "Article", title: "Audit sécurité messagerie email entreprise : SPF, DKIM, DMARC, BEC", desc: "Audit complet de la messagerie d'entreprise : SPF, DKIM, DMARC, Exchange Online, Google Workspace, détection des règles de forwarding malveillantes et Business Email Compromise.", date: "28 Juin 2026", slug: "/actualites/audit-securite-messagerie-email-entreprise", img: imgM365 },
  { tag: "Article", title: "Audit sécurité Microsoft 365 PME : méthode complète et points de contrôle 2026", desc: "Guide complet pour auditer la sécurité de Microsoft 365 en PME : Secure Score, Conditional Access, Exchange Online Protection, Entra ID, MFA, DLP et conformité NIS2 et RGPD.", date: "28 Juin 2026", slug: "/actualites/audit-microsoft-365-securite-pme", img: imgM365 },
  ...
  { tag: "Article", title: "Sanctions NIS2 : que risque une entreprise non conforme en France ?", desc: "Montants des amendes NIS2, critères d'application, responsabilité personnelle des dirigeants et plan d'action pour éviter les sanctions. Guide complet 2026.", date: "28 Juin 2026", slug: "/actualites/sanctions-nis2-non-conformite-entreprise", img: imgNIS2 },
  { tag: "Article", title: "Budget cybersécurité PME 50 salariés : combien investir en 2026 ?", desc: "Benchmarks sectoriels, ventilation des postes de dépenses, coût d'une cyberattaque et aides BPI France. Guide budgétaire complet pour les PME.", date: "28 Juin 2026", slug: "/actualites/budget-cybersecurite-pme-50-salaries", img: imgCout },
  { tag: "Article", title: "Signalement incident cybersécurité ANSSI et CNIL : obligations et délais", desc: "Qui doit notifier un incident cyber à l'ANSSI ? Dans quel délai notifier la CNIL ? Procédures, sanctions et comment se préparer. Guide NIS2 et RGPD.", date: "28 Juin 2026", slug: "/actualites/signalement-incident-cybersecurite-anssi-obligation", img: imgApres },
  { tag: "Article", title: "Checklist cybersécurité PME : 42 points essentiels (inspirée ANSSI)", desc: "Checklist opérationnelle de 42 mesures cybersécurité classées par thème : gouvernance, accès, postes, messagerie, sauvegardes et cloud. Imprimez et cochez.", date: "28 Juin 2026", slug: "/actualites/checklist-cybersecurite-pme-anssi", img: imgObligatoire },
  { tag: "Article", title: "Audit cybersécurité avant levée de fonds : ce que les investisseurs vérifient", desc: "Due diligence cyber des VC et fonds d'investissement : ce qu'ils examinent, les red flags qui font fuir et comment transformer la due diligence en avantage.", date: "28 Juin 2026", slug: "/actualites/audit-cybersecurite-avant-levee-de-fonds", img: imgAudit },
  { tag: "Article", title: "Cybersécurité PME sans DSI : guide pour dirigeants non techniciens", desc: "Votre PME n'a pas de DSI ? 10 mesures immédiates sans compétences techniques, options d'externalisation et ressources ANSSI gratuites.", date: "28 Juin 2026", slug: "/actualites/cybersecurite-pme-sans-dsi-dirigeant-non-technicien", img: imgPME },
  { tag: "Article", title: "Audit cyber exigé par votre client grand compte : comment répondre ?", desc: "Questionnaire de sécurité, audit par le client, rapport de pentest : les 4 formes d'exigences cyber des grands comptes et comment y répondre efficacement.", date: "28 Juin 2026", slug: "/actualites/audit-cyber-exige-client-grand-compte", img: imgPrestataire },
  { tag: "Article", title: "Maturité cybersécurité PME : évaluer son niveau et progresser", desc: "Les 5 niveaux du modèle de maturité cyber, comment vous situer, méthodes d'évaluation gratuites et payantes, et feuille de route pour progresser.", date: "28 Juin 2026", slug: "/actualites/maturite-cybersecurite-pme-comment-evaluer", img: imgAD },
  { tag: "Article", title: "Financement audit cybersécurité PME : aides BPI France, ANSSI et régions", desc: "Tous les dispositifs pour financer un audit cyber : Mon Aide Cyber (gratuit), prêt BPI France, subventions régionales, co-financement CCI. Guide 2026.", date: "28 Juin 2026", slug: "/actualites/financement-audit-cybersecurite-bpi-france-anssi", img: imgCout },
  { tag: "Article", title: "DORA cybersécurité : obligations et conformité pour les entreprises financières", desc: "Guide complet DORA : périmètre (banques, fintechs, assurances), 5 piliers, notification des incidents à l'ACPR/AMF (4h), tests TLPT et sanctions jusqu'à 2 % du CA mondial.", date: "28 Juin 2026", slug: "/actualites/dora-cybersecurite-entreprise-financiere", img: imgNIS2 },
  { tag: "Article", title: "Article 32 RGPD : mesures techniques de sécurité obligatoires pour votre entreprise", desc: "Article 32 RGPD décrypté : mesures techniques attendues (chiffrement, MFA, pseudonymisation), ce que la CNIL vérifie lors des contrôles et comment prouver votre conformité.", date: "28 Juin 2026", slug: "/actualites/article-32-rgpd-mesures-techniques-securite", img: imgRGPD },
  { tag: "Article", title: "Scan de vulnérabilités réseau pour PME : guide complet 2026", desc: "Tout savoir sur le scan de vulnérabilités réseau : interne vs externe, outils Nessus/OpenVAS/Qualys, lecture des résultats CVSS, fréquence et différence avec le pentest.", date: "28 Juin 2026", slug: "/actualites/scan-vulnerabilites-reseau-pme", img: imgVs },
  { tag: "Article", title: "Sécuriser les accès distants RDP et VPN en entreprise : guide PME 2026", desc: "RDP exposé sur Internet : 12 mesures concrètes pour le sécuriser, risques spécifiques VPN (CVE Fortinet/Ivanti), alternatives Zero Trust et monitoring des sessions distantes.", date: "28 Juin 2026", slug: "/actualites/securisation-acces-distants-rdp-vpn-pme", img: imgTeletravail },
  { tag: "Article", title: "Cyber Resilience Act : obligations pour les PME éditeurs et fabricants en France", desc: "Cyber Resilience Act expliqué : qui est concerné (éditeurs logiciels, IoT), 4 classes de produits, obligations (sécurité by design, MAJ 5 ans, marquage CE) et calendrier jusqu'à décembre 2027.", date: "28 Juin 2026", slug: "/actualites/cyber-resilience-act-obligations-pme-france", img: imgNIS2 },
  { tag: "Article", title: "Audit des sauvegardes en entreprise : méthode, tests et obligations 2026", desc: "Méthode d'audit des sauvegardes : vérification 3-2-1, tests de restauration chronométrés, mesure RTO/RPO réel, immuabilité anti-ransomware, conformité RGPD et NIS2. Checklist en 12 points.", date: "28 Juin 2026", slug: "/actualites/audit-sauvegarde-donnees-entreprise", img: imgBackup },
];
